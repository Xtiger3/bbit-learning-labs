...
if __name__ == "__main__":
    ...
    #                       WRITE CODE HERE!!!
    #
    ticker = sys.argv[1] if len(sys.argv) >= 2 else 'anon'
    price = sys.argv[2] if len(sys.argv) >= 3 else 0
    sector = sys.argv[3] if len(sys.argv) >= 4 else 'anon'
